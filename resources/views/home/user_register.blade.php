...
<div class="step1 col-lg-12">
    <div class="container">
        <div class="row">
            ...
            <p style="text-align: center; font-size: 25px; font-family: Avenir "> Register as a User</p>
            <br>
            <form  method="post" action="{{route('post_user')}}" class="col-md-10 col-xs-push-2" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-5 wow flipInX {{ $errors->has('name') ? 'has-error' : '' }}" data-wow-duration="2s" data-wow-delay="3s">
                        ...
                        <input type="text" name="name" class="form-control" id="exampleInputAge" placeholder="full name" >
                    </div>
