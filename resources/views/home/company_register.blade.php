...
<div class="step1 col-lg-12">
    <div class="container">
        <div class="row">
            ...
            <form  method="post" action="{{route('post_company')}}" class="col-md-10 col-xs-push-2" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-xs-5 wow flipInX {{ $errors->has('name') ? 'has-error' : '' }}" data-wow-duration="2s" data-wow-delay="3s">
                        <label for="exampleInputPassword1">Commercial name</label>
                        <input type="text" name="name" class="form-control" id="exampleInputPassword1" placeholder="Commercial name" value="{{ old('name') }}" required>

                    </div>
                    <div class="form-group col-xs-5 wow flipInX {{ $errors->has('specify') ? 'has-error' : '' }}" data-wow-duration="2s" data-wow-delay="3s">
                        <label for="exampleInputAge">Commercial activity</label>
                        <input type="text" name="specify" class="form-control" id="exampleInputAge" placeholder="Commercial activity" value="{{ old('specify') }}" required>
